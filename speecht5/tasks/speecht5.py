...
class SpeechT5Task(LegacyFairseqTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if self.t5_task == "s2t":
            ...
            self.datasets[split] = SpeechToTextDataset(
                ...
                store_labels=True, # Raghu changed
                tgt_dict=self.dicts["text"],
                tokenizer=bpe_tokenizer,
                include_constraints=self.args.constraints if hasattr(self.args, 'constraints') else None #Raghu changed
            )
    ...
    def build_generator(
        ...
        if extra_gen_cls_kwargs:
            ...
            extra_gen_cls_kwargs = {"ctc_weight": self.args.ctc_weight}
